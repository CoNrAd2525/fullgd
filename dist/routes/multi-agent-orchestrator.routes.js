...
exports.createMultiAgentOrchestratorRoutes = void 0;
const express_1 = require("express");
const multi_agent_orchestrator_controller_1 = require("../controllers/multi-agent-orchestrator.controller");
const auth_1 = require("../middleware/auth");
const createMultiAgentOrchestratorRoutes = (io) => {
    const router = (0, express_1.Router)();
    const controller = new multi_agent_orchestrator_controller_1.MultiAgentOrchestratorController(io);
...
exports.createMultiAgentOrchestratorRoutes = createMultiAgentOrchestratorRoutes;
exports.default = exports.createMultiAgentOrchestratorRoutes;
