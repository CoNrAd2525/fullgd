...
class PipedreamController {
    constructor(prisma) {
        ...
        this.getIntegrationStatus = async (req, res) => {
            try {
                const userId = req.user.id;
        ...
        // Trigger a workflow
        this.triggerWorkflow = async (req, res) => {
            try {
                const userId = req.user.id;
        ...
        this.sendCollaborationEvent = async (req, res) => {
            try {
                const userId = req.user.id;
        ...
        // Send agent event
        this.sendAgentEvent = async (req, res) => {
            try {
                const userId = req.user.id;
        ...
        this.disconnectIntegration = async (req, res) => {
            try {
                const userId = req.user.id;
        ...
        // Test integration
        this.testIntegration = async (req, res) => {
            try {
                const userId = req.user.id;
...
exports.PipedreamController = PipedreamController;
