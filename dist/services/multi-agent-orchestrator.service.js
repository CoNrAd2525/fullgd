...
exports.MultiAgentOrchestratorService = void 0;
class MultiAgentOrchestratorService {
    constructor(prisma, io, agentService, collaborationService, webhookService, pipedreamService) {
    ...
    async createSpecializedAgent(userId, config) {
        try {
    ...
    async createAgentFlowOrchestration(userId) {
        try {
    ...
    async executeOrchestrationPlan(sessionId, plan) {
        try {
    ...
    // Helper methods
    mergeIntegrations(templateIntegrations, userIntegrations) {
    ...
    async initializeFrameworkSpecifics(agent, config) {
    ...
    async initializeHyperAgent(agent, config) {
    ...
    async initializeActivepieces(agent, config) {
    ...
    async initializeCybersecurityAI(agent, config) {
    ...
    async initializeSmolAgents(agent, config) {
    ...
    async initializeAgno(agent, config) {
...
exports.MultiAgentOrchestratorService = MultiAgentOrchestratorService;
